            ...
            <Wrapper>
                ...
                <Div className="mb-10 relative">
                    ...
                    <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                        Here is Some Reviews from my Linkedin Accounts.
                    </div>
                </Div>
                {/* SECTION HEADING END */}
                    ...
                    <Carousel>
                        ...
                        <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
                            <div className="mb-[25px]">
                                <img
                                    src="https://i0.wp.com/www.coolingindia.in/wp-content/uploads/2020/02/yatheendar-ramakrishna-parker.jpg?fit=300%2C300&ssl=1"
                                    className="w-[80px] h-[80px] max-w-[80px] rounded-full"
                                />
                                <div className="font-bold">Saim Chaudhary</div>
                                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                                    ~Achivements~
                                </div>
                            </div>
                            <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                                This is the best project on MERN Stacks i've ever seen till Now.
                                It's far more better than other Projects. Thank you for Sharing 
                                it for us pepole like it.
                        ...
                        <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
                            <div className="mb-[25px]">
                                <img
                                    src="https://images.pexels.com/photos/2913125/pexels-photo-2913125.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=300"
                                    className="w-[80px] h-[80px] max-w-[80px] rounded-full"
                                />
                                <div className="font-bold">Rimi Datta</div>
                                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                                ~Achivements~
                                </div>
                            </div>
                            <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                                Awesome Dude.... your Projects is so clear and very easy to understand.
                                 Make more projects like this in MERN stack and thanks for sharings.
                                 it is really informative keep making...
                            </div>
                        </div>
                        {/* SLIDE END */}
                        {/* SLIDE START */}
                        <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
                            <div className="mb-[25px]">
                                <img
                                    ...
                                    className="w-[80px] h-[80px] max-w-[80px] rounded-full"
                                />
                                <div className="font-bold"> Sanjay Singh </div>
                                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                                ~Achivements~
                                </div>
                            </div>
                            <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                                I must Say, till now i haven't seen anybody posted any projects with such an ease and clarity.
                                Thanks man. Hope to See Your projects making boom on Linkedin...
                            </div>
                        </div>
                        {/* SLIDE END */}
                    </Carousel>
