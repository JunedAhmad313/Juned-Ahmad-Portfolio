                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            ...
                            desc="As a  front-end developer I creat websites and applications using web languages such as HTML, CSS, and JavaScript that allow users to access and interact with the site or app.
                        ...
                        <Service
                            ...
                            desc="As a web developer I develops World Wide Web applications using a client–server model. The applications typically use HTML, CSS, and JavaScript in the client,
                             and any general-purpose programming language in the server. This HTTP is used for communications between client and server."
                            data={[
                                "HTML, HTML5",
                                "CSS",
                                "SCSS",
                        ...
                        <Service
                            ...
                            desc="As a MERN Stack developers I have in-depth knowledge of NodeJS, ExpressJS or Restify and have the ability to bind UI elements to JavaScript object models. I have experience creating RESTful services with Node. js and I also proficient in OOPs and database concepts."
                            data={[
                                "HTML",
                                "CSS",
                                "JAVASCRIPT",
