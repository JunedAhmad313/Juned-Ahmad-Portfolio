            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>junedahmad9296gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Juned Ahmad</span>
                    </div>
                    <div className="max-w-[510px]">
                        I create and maintain modern websites and applications.
                        I'm a passionate Devloper,with strong administrative and 
                        communication skills, good attention to detail and the ability to write
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                        <div className="text-[80px] font-light">40+</div>
